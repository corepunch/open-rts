...
typedef enum {
    ...
    S_DC_GRAY_STND, S_DC_GRAY_RUN1, S_DC_GRAY_RUN2, S_DC_GRAY_RUN3, S_DC_GRAY_RUN4, S_DC_GRAY_RUN5, S_DC_GRAY_RUN6, S_DC_GRAY_RUN7,
    ...
    S_DC_EXPL_STND,
    S_DC_MUZA1, S_DC_MUZA2, S_DC_MUZA3,
    NUMSTATES
} statenum_t;

typedef enum { MT_NULL, MT_DC_TROOPER, MT_DC_GREY, MT_DC_EXPLOITER, NUMMOBJTYPES } mobjtype_t;
